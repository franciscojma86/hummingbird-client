...
static const UInt8 kKeychainItemIdentifier[] = "com.franciscojma86.HummingBird.Keychain\0";
...
- (instancetype)init {
    ...
    if (self) {
        ...
        [_genericPasswordQuery setObject:keychainItemID
...
- (void)resetKeychainItem {
    if (!_keychainData) {
        ...
        DLog(@"Coudln't find keychain item %zd",errorcode);
